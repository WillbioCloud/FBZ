window.FBZ_DATA = {
  whatsappPhone: "556193291812", // Seu número real
  ...
  empreendimentos: [
    ...
    },
    {
      ...
      descCurta: "Um projeto com foco em áreas verdes e organização urbana. O elo de conexão da região sul.",
    ...
    },
    {
    ...
    },
     {
      ...
      descCurta: "Localização estratégica ao lado das principais faculdades. Ideal para kitnets.",
    ...
    },
    {
        ...
        descCurta: "Oportunidade única de investimento em um shopping moderno e bem localizado.",
        heroImg: "https://images.unsplash.com/photo-1549924231-f129b911e442?q=80",
        destaques: ["Lojas variadas", "Estacionamento amplo", "Localização estratégica", "Alto fluxo de pessoas"],
    ...
    },
    {
        ...
        descCurta: "Lotes residenciais em um ambiente florido e tranquilo, perfeito para sua família.",
